...
<head>
    ...
    <title>{{ config('app.name', 'EduCore') }} — @yield('title', 'Panel')</title>
...
<aside class="sidebar">
    ...
    <div class="sidebar-logo">
        <div class="wordmark">Edu<span>Core</span></div>
        <div class="tagline">Plataforma Académica Central</div>
    </div>
    ...
    <a href="{{ route('institutions.index') }}" class="nav-item {{ request()->routeIs('institutions.*') ? 'active' : '' }}">
        <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <a href="{{ route('cycles.index') }}" class="nav-item {{ request()->routeIs('cycles.*') ? 'active' : '' }}">
        <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <a href="{{ route('config.index') }}" class="nav-item {{ request()->routeIs('config.*') ? 'active' : '' }}">
        <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div class="sidebar-footer" style="position:relative;">
        ...
        <div id="user-menu" style="display:none; position:absolute; bottom:72px; left:12px; right:12px; background:#1A2B3C; border-radius:12px; border:1px solid rgba(255,255,255,0.08); overflow:hidden; box-shadow:0 8px 24px rgba(0,0,0,0.3);">
            <a href="{{ route('profile.edit') }}" style="display:flex; align-items:center; gap:10px; padding:12px 16px; color:rgba(255,255,255,0.75); text-decoration:none; font-size:0.83rem;" onmouseover="this.style.background='rgba(255,255,255,0.05)'" onmouseout="this.style.background='transparent'">
                👤 Mi perfil
            </a>
...
<div class="main-wrapper">
    ...
    {{-- Top Bar --}}
    <header class="topbar">
        <div class="topbar-title">@yield('page-title', 'Inicio')</div>
