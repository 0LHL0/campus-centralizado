...
@section('page-title', 'Editar Mensaje')
@section('content')
...
<div style="display:flex; align-items:center; gap:12px; margin-bottom:32px;">
    ...
    <div>
        <h2 style="font-family:'Playfair Display',serif; font-size:1.3rem; font-weight:700; color:var(--text-primary); margin:0;">Editar Mensaje</h2>
        <p style="font-size:0.8rem; color:var(--text-secondary); margin:3px 0 0;">Editando: <strong style="color:var(--accent);">{{ $message->title }}</strong></p>
    </div>
</div>
