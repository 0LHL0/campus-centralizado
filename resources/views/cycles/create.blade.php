...
<div style="display:flex; align-items:center; gap:12px; margin-bottom:32px;">
    ...
    <div>
        <h2 style="font-family:'Playfair Display',serif; font-size:1.3rem; font-weight:700; color:var(--text-primary); margin:0;">Nuevo Ciclo</h2>
        <p style="font-size:0.8rem; color:var(--text-secondary); margin:3px 0 0;">Completá los datos para registrar un nuevo ciclo</p>
    </div>
</div>
...
<div style="display:flex; justify-content:center;">
    <div style="width:100%; max-width:520px;">
        <div style="background:var(--card); border-radius:20px; border:1px solid #E8EDF5; padding:36px; box-shadow:0 4px 24px rgba(0,0,0,0.05);">
            ...
            {{-- action apunta a cycles.store → método store() del controlador --}}
            <form action="{{ route('cycles.store') }}" method="POST">
                ...
                <div style="margin-bottom:20px;">
                    ...
                    {{-- old('name') recupera el valor si el formulario falló --}}
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Ej: Ciclo 2026"
                ...
                <div style="margin-bottom:28px;">
                    ...
                    {{-- El select muestra todas las instituciones que vienen del controlador --}}
                    <select name="institution_id"
                        ...
                        @foreach($institutions as $institution)
                            {{-- old('institution_id') mantiene la selección si el formulario falló --}}
                ...
                <div style="display:flex; gap:12px;">
                    <button type="submit" style="padding:11px 28px; background:var(--accent); color:#fff; border:none; border-radius:10px; font-size:0.88rem; font-weight:600; cursor:pointer; font-family:'Plus Jakarta Sans',sans-serif;">Guardar ciclo</button>
